...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.pl = {
		...
		messages: {
		    ...
		    'errSim': 'Nie można wysłać pliki w wiadomości e-mail',
		    'cmdsim': 'Wyślij e-mailem',
		    'confirmSim': 'Czy na pewno chcesz wysłać ten / te pliki przez e-mail?',
		    'btnSim': 'wysłać',
		    'ntfsim': 'Wysyłanie plików',
