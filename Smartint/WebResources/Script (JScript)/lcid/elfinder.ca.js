...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ca = {
		...
		messages: {
		    ...
		    'errSim': "No es pot enviar l'arxiu per correu electrònic.",
		    'cmdsim': 'Enviar per email',
		    'confirmSim': 'Esteu segur que voleu enviar aquest / aquests arxius per correu electrònic?',
		    'btnSim': 'Enviar',
		    'ntfsim': "Enviament d'arxius",
