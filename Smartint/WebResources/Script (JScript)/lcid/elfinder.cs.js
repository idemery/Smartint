...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.cs = {
		...
		messages: {
		    ...
		    'errSim': 'Nelze odesílat soubory e-mailem.',
		    'cmdsim': 'Poslat e-mailem',
		    'confirmSim': 'Jste si jisti, že chcete odeslat tuto / tyto soubory přes e-mail?',
		    'btnSim': 'Odeslat',
		    'ntfsim': 'Odesílání souborů',
