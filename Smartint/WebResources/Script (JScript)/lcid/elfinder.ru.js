...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages: {
		    ...
		    'errSim': 'Невозможно отправить файлы по электронной почте.',
		    'cmdsim': 'Отправить по электронной почте',
		    'confirmSim': 'Вы уверены, что хотите отправить это / эти файлы по электронной почте?',
		    'btnSim': 'послать',
		    'ntfsim': 'Отправка файлов',
