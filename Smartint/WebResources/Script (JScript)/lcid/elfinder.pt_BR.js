...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.pt_BR = {
		...
		messages: {
		    ...
		    'errSim': 'Não é possível enviar arquivos no e-mail',
		    'cmdsim': 'Enviar por e-mail',
		    'confirmSim': 'Tem certeza de que deseja enviar este / estes arquivos via e-mail?',
		    'btnSim': 'enviar',
		    'ntfsim': 'Envio de arquivos',
